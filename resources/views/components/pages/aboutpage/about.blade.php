        ...
        <div class="grid items-center grid-cols-1 md:grid-cols-2">
            ...
            <div>
                <h2 class="text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl lg:text-5xl">Hey 👋 I
                    am
                    <br class="block sm:hidden" />Yonathan Martin
                </h2>
            ...
            <div class="relative">
                ...
                <img class="relative w-full xl:max-w-lg xl:mx-auto 2xl:origin-bottom 2xl:scale-110" src="Yonathan-removebg-preview.png" alt="" />
            </div>
